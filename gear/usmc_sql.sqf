...
for "_i" from 1 to 2 do {_this addItemToVest "rhs_mag_30Rnd_556x45_Mk318_Stanag";};
_this addBackpack "tf_rt1523g_big_rhs";
for "_i" from 1 to 2 do {_this addItemToBackpack "rhs_mag_an_m8hc";};
for "_i" from 1 to 2 do {_this addItemToBackpack "HandGrenade";};
for "_i" from 1 to 4 do {_this addItemToBackpack "rhs_mag_M441_HE";};
_this addItemToBackpack "rhs_mag_M585_white";
_this addItemToBackpack "rhs_mag_m661_green";
for "_i" from 1 to 2 do {_this addItemToBackpack "rhs_mag_m662_red";};
_this addItemToBackpack "rhs_mag_m713_Red";
_this addItemToBackpack "rhs_mag_m714_White";
for "_i" from 1 to 2 do {_this addItemToBackpack "ACE_HandFlare_Red";};
for "_i" from 1 to 4 do {_this addItemToBackpack "rhs_mag_30Rnd_556x45_M855A1_Stanag_Tracer_Red";};
