...
for "_i" from 1 to 3 do {_this addItemToBackpack "ACE_surgicalKit";};
...
for "_i" from 1 to 4 do {_this addItemToBackpack "rhs_mag_30Rnd_556x45_Mk318_Stanag";};
for "_i" from 1 to 3 do {_this addItemToBackpack "rhs_mag_an_m8hc";};
